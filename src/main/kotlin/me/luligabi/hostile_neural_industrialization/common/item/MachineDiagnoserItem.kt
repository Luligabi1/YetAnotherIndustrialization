...
import me.luligabi.hostile_neural_industrialization.common.item.MachineDiagnoserItem.DiagnosisType.Companion.sendDiagnosis
import me.luligabi.hostile_neural_industrialization.common.util.HNIText
import me.luligabi.hostile_neural_industrialization.common.util.applyColor
import me.luligabi.hostile_neural_industrialization.common.util.applyStyle
...
import me.luligabi.hostile_neural_industrialization.mixin.UseOnContextAccessor
...
class MachineDiagnoserItem(properties: Properties) : Item(properties) {
    ...
    private fun diagnoseHatches(machine: MultiblockMachineBlockEntity, diagnosis: MutableSet<DiagnosisType>): MutableSet<DiagnosisType> {
        ...
        val matchedHatches = (machine as MultiblockMachineBlockEntityAccessor).shapeMatcher.matchedHatches.let {
    ...
    enum class DiagnosisType(val title: HNIText, val description: HNIText, val severity: Severity) {

        NO_STEAM(HNIText.DIAGNOSER_NO_STEAM, HNIText.DIAGNOSER_NO_STEAM_DESCRIPTION, Severity.ERROR),
        NO_ENERGY(HNIText.DIAGNOSER_NO_ENERGY, HNIText.DIAGNOSER_NO_ENERGY_DESCRIPTION, Severity.ERROR),
        NO_ENERGY_WARNING(HNIText.DIAGNOSER_NO_ENERGY, HNIText.DIAGNOSER_NO_ENERGY_WARNING_DESCRIPTION, Severity.WARNING),
        NO_ENERGY_INPUT(HNIText.DIAGNOSER_NO_ENERGY_INPUT, HNIText.DIAGNOSER_NO_ENERGY_INPUT_DESCRIPTION, Severity.ERROR),
        NO_ENERGY_OUTPUT(HNIText.DIAGNOSER_NO_ENERGY_OUTPUT, HNIText.DIAGNOSER_NO_ENERGY_OUTPUT_DESCRIPTION, Severity.ERROR),
        NO_RECIPE(HNIText.DIAGNOSER_NO_RECIPE, HNIText.DIAGNOSER_NO_RECIPE_DESCRIPTION, Severity.ERROR),
        BANNED_RECIPE(HNIText.DIAGNOSER_BANNED_RECIPE, HNIText.DIAGNOSER_BANNED_RECIPE_DESCRIPTION, Severity.ERROR),
        CANT_TAKE_ITEM_INPUT(HNIText.DIAGNOSER_CANT_TAKE_ITEM_INPUT, HNIText.DIAGNOSER_CANT_TAKE_ITEM_INPUT_DESCRIPTION, Severity.WARNING),
        CANT_TAKE_FLUID_INPUT(HNIText.DIAGNOSER_CANT_TAKE_FLUID_INPUT, HNIText.DIAGNOSER_CANT_TAKE_FLUID_INPUT_DESCRIPTION, Severity.WARNING),
        CANT_PUT_ITEM_OUTPUT(HNIText.DIAGNOSER_CANT_PUT_ITEM_OUTPUT, HNIText.DIAGNOSER_CANT_PUT_ITEM_OUTPUT_DESCRIPTION, Severity.ERROR),
        CANT_PUT_FLUID_OUTPUT(HNIText.DIAGNOSER_CANT_PUT_FLUID_OUTPUT, HNIText.DIAGNOSER_CANT_PUT_FLUID_OUTPUT_DESCRIPTION, Severity.ERROR),
        CANT_PUT_ITEM_OUTPUT_WARNING(HNIText.DIAGNOSER_CANT_PUT_ITEM_OUTPUT, HNIText.DIAGNOSER_CANT_PUT_ITEM_OUTPUT_DESCRIPTION, Severity.WARNING),
        CANT_PUT_FLUID_OUTPUT_WARNING(HNIText.DIAGNOSER_CANT_PUT_FLUID_OUTPUT, HNIText.DIAGNOSER_CANT_PUT_FLUID_OUTPUT_DESCRIPTION, Severity.WARNING),
        UNMET_CONDITION(HNIText.DIAGNOSER_UNMET_CONDITION, HNIText.DIAGNOSER_UNMET_CONDITION_DESCRIPTION, Severity.ERROR),
        INVALID_MULTIBLOCK_SHAPE(HNIText.DIAGNOSER_INVALID_MULTIBLOCK_SHAPE, HNIText.DIAGNOSER_INVALID_MULTIBLOCK_SHAPE_DESCRIPTION, Severity.ERROR),
        NO_LARGE_TANK_HATCH(HNIText.DIAGNOSER_NO_LARGE_TANK_HATCH, HNIText.DIAGNOSER_NO_LARGE_TANK_HATCH_DESCRIPTION, Severity.ERROR);
        ...
        companion object {
            ...
            fun Player.sendDiagnosis(diagnosis: MutableSet<DiagnosisType>, machine: MachineBlockEntity) {
                ...
                if (diagnosis.isEmpty()) {
                    sendSystemMessage(
                        HNIText.DIAGNOSER_TITLE_NONE.text(machineName).applyStyle(TextHelper.NEUTRONS)
                    )
                    return
                }

                val title = HNIText.DIAGNOSER_TITLE.text(machineName).applyStyle(TextHelper.GRAY_TEXT)

                val sortedList = diagnosis.sortedBy { it.ordinal }
