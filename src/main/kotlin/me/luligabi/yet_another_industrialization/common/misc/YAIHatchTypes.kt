...
object YAIHatchTypes {
    ...
    val MIXED_INPUT = HatchTypes.register(YAI.id("mixed_input"), YAI.TEXT.mixedInputHatch())
    val MIXED_OUTPUT = HatchTypes.register(YAI.id("mixed_output"), YAI.TEXT.mixedOutputHatch())
