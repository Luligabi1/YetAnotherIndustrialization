...
data class ArboreousGreenhouseTier(
    ...
    constructor(
        ...
        nutrientFluid: ResourceLocation? = YAIFluids.NUTRIENT_RICH_WATER.identifier().location,
    ...
    companion object {
        ...
        val DEFAULT_TIER = YAI.id("grass_block")

        fun all() = BuiltInRegistries.BLOCK.getDataMap(YAIDataMaps.ARBOREOUS_GREENHOUSE_TIER)
